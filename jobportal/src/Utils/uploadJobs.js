...
const jobs = [
        ...
        },
        {
          ...
          "company": {
            ...
            "contactPhone": "444-123-1672"
          }
        }
   
    
  // Add the rest of your job listings here...
];

const uploadJobsToFirestore = async () => {
  try {
    const jobsCollection = collection(db, "jobs"); // Reference "jobs" collection
